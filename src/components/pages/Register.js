  ...
  return (
    <div className='d-flex flex-wrap justify-content-center align-items-center'>
        <div className='text-center p-2'>
            <img src={"https://dummyimage.com/512x512/ddd/000.png&text=Logo"} alt='pandavas-register' style={{height: '150px'}} />
            <h1 className='display-3 text-primary my-0'>Create an Account!</h1>
            <p className='lead'><small>Enter all the required details and verify your Email for creating a new Account.</small></p>
        </div>
        <div className='text-dark bg-light m-3 p-5 col-md-5 rounded border border-primary'>
            <h2 className='text-center text-primary'>Register</h2>
            <p>Already have an account? then <a className='text-info' href='/login'>Click here</a></p>
            <form>
            <div className="mb-3">
            ...
            <div className='d-flex justify-content-center'>
                <button onClick={handleRegister} type='button' className='btn btn-primary'>Register <i className='bi bi-door-open'></i></button>
            </div>
            </form>
        </div>
    </div>
